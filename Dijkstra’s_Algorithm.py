...
def Dijkstra(graph, source, target):
    # This are all the nodes which have not been visited yet
    ...
    for nodes in unvisited_nodes:
        # Setting the shortest_distance of all the nodes as inifinity
    ...
    while(unvisited_nodes):
        ...
        # Iterating through the connected nodes of current_nodes (for example, a is connected with b and c
        # having values 10 and 3 respectively) and the weight of the edges
        for child_node, value in unvisited_nodes[min_Node].items():
            #check if the value of the current_node + value of the edge
        ...
        # After the node has been visited (also known as related) remove it from unvisited node
    ...
    while node != source:
        #As it is not necessary that the target node can ne reached from the source node,
        ...
        try:
            ...
            break
    # Include the source in the path
    ...
    # Remove the below comment if you want to show the shortest distance
